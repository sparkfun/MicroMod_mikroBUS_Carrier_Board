...
//////////////////////////
#define PIN_RESET 34  // Connect RST to pin INT on the mikroBUS socket
#define PIN_DC    33  // Connect DC to pin PWM on the mikroBUS socket
#define PIN_CS    37 // Connect CS to pin CS on the mikroBUS socket
